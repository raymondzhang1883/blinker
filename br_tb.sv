...
module br_tb;
  ...
  initial begin
    ...
    uut.memory.bytes[8194] = 8'b10000000;  // rd = 2, rs = 0
    uut.memory.bytes[8195] = 8'b01000000;  // opcode=01000  
    ...
    uut.reg_file.registers[2] = 64'h8200;       // Initialize r2 to 0x8200 (33280)
